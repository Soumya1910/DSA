...
## Problem Statements 
1. Nearest Greater/ Next Largest element to Right [NextLargestElementToRight](./src/main/java/com/dsa/stack/NextLargestElementToRight.java)
2. [Nearest Greater/ Next Largest element to Left](./src/main/java/com/dsa/stack/NextLargestElementToLeft.java)
